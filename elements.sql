...
INSERT INTO "elements" VALUES(36,'Kr','Krypton','"the Greek ''kryptos'', meaning hidden"',4,83.798,FALSE,0.248,0.003733,FALSE,115.79,FALSE,119.93,FALSE,3,0.001,1,32);
...
INSERT INTO "elements" VALUES(43,'Tc','Technetium','the Greek ''tekhnetos'' meaning artificial',5,98,1,NULL,11.5,FALSE,2430,FALSE,4538,FALSE,1.9,0.001,1,21);
...
INSERT INTO "elements" VALUES(54,'Xe','Xenon','the Greek ''xenos'' meaning stranger',5,131.293,FALSE,0.158,0.005887,FALSE,161.4,FALSE,165.03,FALSE,2.6,0.001,1,32);
...
INSERT INTO "elements" VALUES(61,'Pm','Promethium','Prometheus of Greek mythology who stole fire from the Gods and gave it to humans',6,145,1,NULL,7.26,FALSE,1315,FALSE,3273,FALSE,1.13,0.001,1,7);
...
INSERT INTO "elements" VALUES(75,'Re','Rhenium','"Rhine, a river that flows from Grisons in the eastern Swiss Alps to the North Sea coast in the Netherlands (with the Latin name Rhenia)"',6,186.207,FALSE,0.137,21.02,FALSE,3459,FALSE,5869,FALSE,1.9,0.001,1,21);
...
INSERT INTO "elements" VALUES(84,'Po','Polonium','"Poland, the native country of Marie Curie, who first isolated the element"',6,209,1,NULL,9.32,FALSE,527,FALSE,1235,FALSE,2,0.001,1,30);
INSERT INTO "elements" VALUES(85,'At','Astatine','"the Greek ''astatos'', meaning unstable"',6,210,1,NULL,7,FALSE,575,FALSE,610,FALSE,2.2,0.001,1,31);
INSERT INTO "elements" VALUES(86,'Rn','Radon','"From radium, as it was first detected as an emission from radium during radioactive decay"',6,222,1,0.094,0.00973,FALSE,202,FALSE,211.3,FALSE,2.2,0.001,1,32);
INSERT INTO "elements" VALUES(87,'Fr','Francium','"France, where it was first discovered"',7,223,1,NULL,1.87,FALSE,300,FALSE,950,FALSE,0.7,0.001,1,1);
INSERT INTO "elements" VALUES(88,'Ra','Radium','"the Latin ''radius'', meaning ray"',7,226,1,0.094,5.5,FALSE,973,FALSE,2010,FALSE,0.9,0.001,1,2);
INSERT INTO "elements" VALUES(89,'Ac','Actinium','"the Greek ''actinos'', meaning a ray"',7,227,1,0.12,10.07,FALSE,1323,FALSE,3471,FALSE,1.1,0.001,1,3);
...
INSERT INTO "elements" VALUES(91,'Pa','Protactinium','"the Greek ''protos'', meaning first, as a prefix to the element actinium, which is produced through the radioactive decay of protactinium"',7,231.03588,FALSE,NULL,15.37,FALSE,1841,FALSE,4300,FALSE,1.5,0.001,1,5);
...
INSERT INTO "elements" VALUES(93,'Np','Neptunium','"Neptune, the eighth planet in the Solar System"',7,237,1,NULL,20.45,FALSE,917,FALSE,4273,FALSE,1.36,0.001,1,7);
INSERT INTO "elements" VALUES(94,'Pu','Plutonium','"Pluto, a dwarf planet in the Solar System"',7,244,1,NULL,19.84,FALSE,912.5,FALSE,3501,FALSE,1.28,0.001,1,8);
INSERT INTO "elements" VALUES(95,'Am','Americium','"Americas, the continent where the element was first synthesized"',7,243,1,NULL,13.69,FALSE,1449,FALSE,2880,FALSE,1.13,0.001,1,9);
INSERT INTO "elements" VALUES(96,'Cm','Curium','"Pierre Curie, a physicist, and Marie Curie, a physicist and chemist"',7,247,1,NULL,13.51,FALSE,1613,FALSE,3383,FALSE,1.28,0.001,1,10);
INSERT INTO "elements" VALUES(97,'Bk','Berkelium','"Berkeley, California, USA, where the element was first synthesized"',7,247,1,NULL,14.79,FALSE,1259,FALSE,2900,FALSE,1.3,0.001,1,11);
INSERT INTO "elements" VALUES(98,'Cf','Californium','"State of California, USA, where the element was first synthesized"',7,251,1,NULL,15.1,FALSE,1173,FALSE,1743,1,1.3,0.001,1,12);
INSERT INTO "elements" VALUES(99,'Es','Einsteinium','"Albert Einstein, physicist"',7,252,1,NULL,8.84,FALSE,1133,FALSE,1269,1,1.3,FALSE,0,13);
INSERT INTO "elements" VALUES(100,'Fm','Fermium','"Enrico Fermi, physicist"',7,257,1,NULL,NULL,FALSE,1125,1,NULL,FALSE,1.3,FALSE,0,14);
INSERT INTO "elements" VALUES(101,'Md','Mendelevium','"Dmitri Mendeleyev, chemist and inventor"',7,258,1,NULL,NULL,FALSE,1100,1,NULL,FALSE,1.3,FALSE,0,15);
INSERT INTO "elements" VALUES(102,'No','Nobelium','"Alfred Nobel, chemist, engineer, innovator, and armaments manufacturer"',7,259,1,NULL,NULL,FALSE,1100,1,NULL,FALSE,1.3,FALSE,0,16);
INSERT INTO "elements" VALUES(103,'Lr','Lawrencium','"Ernest O. Lawrence, physicist"',7,262,1,NULL,NULL,FALSE,1900,1,NULL,FALSE,1.3,FALSE,0,17);
INSERT INTO "elements" VALUES(104,'Rf','Rutherfordium','"Ernest Rutherford, chemist and physicist"',7,267,1,NULL,23.2,1,2400,1,5800,1,NULL,FALSE,0,18);
INSERT INTO "elements" VALUES(105,'Db','Dubnium','"Dubna, Russia"',7,268,1,NULL,29.3,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,19);
INSERT INTO "elements" VALUES(106,'Sg','Seaborgium','"Glenn T. Seaborg, scientist"',7,269,1,NULL,35,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,20);
INSERT INTO "elements" VALUES(107,'Bh','Bohrium','"Niels Bohr, physicist"',7,270,1,NULL,37.1,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,21);
INSERT INTO "elements" VALUES(108,'Hs','Hassium','"Hesse, Germany, where the element was first synthesized"',7,269,1,NULL,40.7,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,22);
INSERT INTO "elements" VALUES(109,'Mt','Meitnerium','"Lise Meitner, physicist"',7,278,1,NULL,37.4,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,23);
INSERT INTO "elements" VALUES(110,'Ds','Darmstadtium','"Darmstadt, Germany, where the element was first synthesized"',7,281,1,NULL,34.8,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,24);
INSERT INTO "elements" VALUES(111,'Rg','Roentgenium','"Wilhelm Conrad R�ntgen, physicist"',7,281,1,NULL,28.7,1,NULL,FALSE,NULL,FALSE,NULL,FALSE,0,25);
INSERT INTO "elements" VALUES(112,'Cn','Copernicium','"Nicolaus Copernicus, astronomer"',7,285,1,NULL,23.7,1,NULL,FALSE,357,FALSE,NULL,FALSE,0,26);
INSERT INTO "elements" VALUES(113,'Uut','Ununtrium','IUPAC systematic element name',7,286,1,NULL,16,1,700,1,1400,1,NULL,FALSE,0,27);
INSERT INTO "elements" VALUES(114,'Fl','Flerovium','"Georgy Flyorov, physicist"',7,289,1,NULL,14,1,340,1,420,1,NULL,FALSE,0,28);
INSERT INTO "elements" VALUES(115,'Uup','Ununpentium','IUPAC systematic element name',7,288,1,NULL,13.5,1,700,1,1400,1,NULL,FALSE,0,29);
INSERT INTO "elements" VALUES(116,'Lv','Livermorium','"Lawrence Livermore National Laboratory (in Livermore, California) which collaborated with JINR on its synthesis"',7,293,1,NULL,12.9,1,708.5,1,1085,1,NULL,FALSE,0,30);
INSERT INTO "elements" VALUES(117,'Uus','Ununseptium','IUPAC systematic element name',7,294,1,NULL,7.2,1,673,1,823,1,NULL,FALSE,0,31);
INSERT INTO "elements" VALUES(118,'Uuo','Ununoctium','IUPAC systematic element name',7,294,1,NULL,5,1,258,1,263,1,NULL,FALSE,0,32);
